...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A1:AX1');
...
->setCellValue('AX2', 'Fecha de creación');
...
$objPHPExcel->getActiveSheet()->getStyle('A1:AX2')->applyFromArray($boldArray);		
...
LEFT OUTER JOIN historialregistro histo ON SG.myse=histo.id_myse where $tabla LIKE '%$dato%'";
...
// Cambiar el nombre de hoja de cálculo
	$objPHPExcel->getActiveSheet()->setTitle('Filtro Licitaciones');
...
// Redirigir la salida al navegador web de un cliente ( Excel5 )
	...
	header('Content-Disposition: attachment;filename="Filtro Licitaciones.xls"');
